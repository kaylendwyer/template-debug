...
The Manitos Community Memory Project is an initiative to establish a community memory project and centralized digital archive for the preservation and sharing of the at-risk cultural heritage of the Indo-Hispano villages of northern NM and southern CO, and the diaspora connected to this region where natives often refer to themselves as “Manitos”, a shortened form of *hermanitos.* 
...
<!-- Swap the positions of this with Ellen Dornan after a higher quality image is acquired <div class="medium-3 columns" style="padding-right: 50px;">
    <img src="../../images/people/placeholder-person.png" alt="" style="max-width: 150px; border-radius: 50%;"/>
</div> -->
