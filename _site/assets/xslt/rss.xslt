...
<xsl:template match="/rss">
	...
	<link rel="canonical" href="/pdhi/assets/xslt/rss.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="RSS Feed (Styled)">
	<meta property="og:description" content="An Institute for Academic/Community Collaboration">
	<meta property="og:url" content="/pdhi/assets/xslt/rss.xslt">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
        <h1 class=""><a href="/pdhi/"><img class="img-responsive" src="/pdhi/images/logos/PDHI-logo-color.svg" alt="The Public Digital Humanities Institute" style="height: 40px; width: auto; padding-bottom: 0.35rem;"/></a></h1>
  ...
  <!-- ROW -->
        <div id="footer-logos" class="row small-collapse align-spaced align-center" style="align-content: vertical;"> <!-- style="display: flex; justify-content: center; align-items: center;" -- Unless I'm doing it wrong, this "bootstrappy" way turns out not to be resposive with foundation -->
          ...
          <div class="small-4 large-3 columns">
            <img id="pdhi-logo" class="footer-logo" src="/pdhi/images/logos/PDHI-logo-white_square.svg" alt="The Public Digital Humanities Institute"/>
          </div><!-- /.large-3.columns -->


          <!-- Column 2 --><!-- IDRH -->
          <div class="small-4 large-5 columns">
            <a href="https://idrh.ku.edu"><img id="idrh-logo" class="footer-logo" src="/pdhi/images/logos/idrh-logo-white.png" alt="The Institute for Digital Research in the Humanities"/></a>
          ...
          <div class="small-4 large-4 columns">
            <a href="https://www.neh.gov"><img id="neh-logo" class="footer-logo" src="/pdhi/images/logos/NEH-seal-white.png" alt="National Endownment for the Humanities"/></a>
...
<!--ROW -->
      ...
      <div id="footer-links" class="row align-spaced">
        ...
        <div class="large-5 columns">
          <hr>
          <a href="/pdhi/schedule/">Schedule</a><hr>
          <a href="/pdhi/logistics/">Logistics</a><hr>
        ...
        <hr>
        <a href="/pdhi/idrh/">About the IDRH</a><hr>
        <a href="/pdhi/contact/">Contact</a>
        <hr>
        </div>

        <div id="footer-neh" style="text-align:center; margin-top:1em; clear:both;">
           <p>&nbsp;</p>
           <p>The Public Digital Humanities Institute has been made possible by a major grant from the <a href="https://www.neh.gov">National Endowment for the Humanities: Democracy demands wisdom</a>. Any views, findings, conclusions, or recommendations expressed in this website do not necessarily represent those of the National Endowment for the Humanities.</p>
        </div>
