  ...
  <!-- ROW -->
        <div class="row align-spaced align-center" style="align-content: vertical;"> <!-- style="display: flex; justify-content: center; align-items: center;" -- Unless I'm doing it wrong, this "bootstrappy" way turns out not to be resposive with foundation -->
          ...
          <div class="small-4 large-5 columns" style="margin-top: 3.5rem;">
            <img id="idrh-logo" class="footer-logo" src="/pdhi/images/logos/idrh-logo-white.png" alt="The Institute for Digital Research in the Humanities"/>
          ...
          <div class="small-4 large-4 columns" style="margin-top: 2.5rem;">
            <img id="neh-logo" class="footer-logo" src="/pdhi/images/logos/NEH-seal-white.png" alt="National Endownment for the Humanities"/>
...
<!--ROW -->
      ...
      <div class="row align-spaced" style="margin-top: 2.5rem;">

        <div id="subfooter-container-01" class="large-3 columns">
        ...
        <div id="subfooter-container-02" class="large-5 columns">
          <hr>
        ...
        <div id="subfooter-container-03" class="large-4 columns">
        <hr>
