 ...
 <div id="footer">
        <div class="row align-spaced align-center" style="align-content: vertical;"> <!-- style="display: flex; justify-content: center; align-items: center;" -- Unless I'm doing it wrong, this "bootstrappy" way turns out not to be resposive with foundation -->
          ...
          <div class="small-4 large-3 columns">
            <img id="pdhi-logo" src="./images/logos/pdhi-logo-white_square.svg" alt="The Public Digital Humanities Institute"/>
          ...
          <!--<div class="small-offset-12 large-5 columns" style="margin-top: 3.5rem;">
            <img src="/pdhi/images/logos/idrh-logo-white.png" alt="The Institute for Digital Research in the Humanities"/>-->
          </div><!-- /.large-4.columns -->
          ...
          <!--<div class="small-offset-12 large-4 columns" style="margin-top: 2.5rem;">
            <img src="/pdhi/images/logos/NEH-seal-white.png" alt="National Endownment for the Humanities"/>-->
          </div><!-- /.large-3.columns -->
